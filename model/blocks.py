...
class ConvBlock_nomal(nn.Module):
    """
    ...
    def __init__(
        self,
        n_embd,                # dimension of the input features
        out_dim,    # expansion factor of feat dims
...
class DownBlock(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size=3, stride=1, padding=1, dilation=1, norm=True, dropout=0.1):
...
class Contraction2(nn.Module):
    def __init__(self,in_channels,out_channels,hidden_dims=256, dropout=0.1):
        super(Contraction2, self).__init__()
        self.down_1 = DownBlock(in_channel=in_channels, out_channel=hidden_dims*8, dropout=dropout)
        self.down_2 = DownBlock(in_channel=hidden_dims*8, out_channel=hidden_dims*4, dropout=dropout)
        self.down_3 = DownBlock(in_channel=hidden_dims*4, out_channel=hidden_dims*2, dropout=dropout)
        self.down_4 = DownBlock(in_channel=hidden_dims*2, out_channel=hidden_dims, dropout=dropout)
        self.down_5 = DownBlock(in_channel=hidden_dims, out_channel=out_channels, dropout=dropout)
...
class DownBlock_nomal(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size=3, stride=1, padding=1, dilation=1, norm=True):
        super(DownBlock_nomal, self).__init__()
...
class Conv1d_block(nn.Module):
    def __init__(self,in_channels,out_channels,hidden_dims=256):
        ...
        self.down_1 = DownBlock_nomal(in_channel=in_channels, out_channel=hidden_dims*8)
        self.down_2 = DownBlock_nomal(in_channel=hidden_dims*8, out_channel=hidden_dims*4)
        self.down_3 = DownBlock_nomal(in_channel=hidden_dims*4, out_channel=hidden_dims*2)
        self.down_4 = DownBlock_nomal(in_channel=hidden_dims*2, out_channel=hidden_dims)
        self.down_5 = DownBlock_nomal(in_channel=hidden_dims, out_channel=out_channels)
...
class DeepInterpolator(nn.Module):
    def __init__(self, in_channels,out_channels,hidden_channels=512, norm=False):
        super(DeepInterpolator, self).__init__()
        self.norm = norm
        self.contraction = Contraction(in_channels,hidden_channels)
        self.expansion = Expansion(hidden_channels, out_channels,tanh=False)
